...
export default function LoginPage() {
  return (
    <section className="mx-auto grid max-w-6xl gap-8 px-4 py-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
      <div>
        <p className="text-sm font-black uppercase tracking-widest text-trophy">Area do boleiro</p>
        <h1 className="mt-2 text-4xl font-black text-white">Entre para salvar seus palpites da Copa</h1>
