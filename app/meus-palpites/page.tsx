  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-4xl font-black text-white">Meu historico de palpites</h1>
        <p className="mt-3 font-semibold leading-relaxed text-slate-300">
          Seus palpites salvos aparecem aqui quando o Supabase estiver configurado e voce estiver logado.
        </p>
      </div>
      <SavedPredictions />
    </section>
